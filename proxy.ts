...
const PUBLIC_PATHS = ["/", "/login", "/auth/callback", "/auth/signout", "/auth/error", "/privacy", "/api/instagram/status", "/api/instagram/profile-feed", "/google8c93875b25820bf1.html", "/sitemap.xml", "/robots.txt", "/manifest.webmanifest"];
