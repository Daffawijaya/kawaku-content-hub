...
const pillSolid =
  "inline-flex h-9 min-h-[44px] items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-zinc-900 px-4 text-sm font-medium text-white hover:bg-zinc-800 disabled:opacity-50 sm:min-h-0 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100";
...
export function DeleteConfirmFooter({
  ...
  return (
    <>
      <button type="button" onClick={onCancel} className={`${pillGlass} min-h-[44px] sm:min-h-0`}>
        Batal
      </button>
