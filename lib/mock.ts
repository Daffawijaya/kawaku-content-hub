...
export const mediaLibrary: MediaAsset[] = [
  { id: "m1", name: "panen-raya-cover.jpg", kind: "image", type: "reels", sizeLabel: "2.4 MB", sizeBytes: 2516582, uploadedAt: "2026-09-10", uploadedBy: "Sinta Maharani", tone: "from-emerald-100 to-teal-50 dark:from-emerald-950 dark:to-zinc-900", usedBy: ["c1"], driveFileId: "drive_mock_m1" },
  { id: "m2", name: "panen-raya-teaser.mp4", kind: "video", type: "reels", sizeLabel: "48.2 MB", sizeBytes: 50541363, duration: "00:45", uploadedAt: "2026-09-10", uploadedBy: "Sinta Maharani", tone: "from-emerald-100 to-teal-50 dark:from-emerald-950 dark:to-zinc-900", usedBy: ["c1"], driveFileId: "drive_mock_m2" },
  ...
  { id: "m6", name: "mangrove-drone.mp4", kind: "video", type: "reels", sizeLabel: "120.5 MB", sizeBytes: 126353408, duration: "02:10", uploadedAt: "2026-09-05", uploadedBy: "Nadia Putri", tone: "from-teal-100 to-emerald-50 dark:from-teal-950 dark:to-zinc-900", usedBy: ["c4"], driveFileId: "drive_mock_m6" },
  ...
  { id: "m12", name: "foto-produk-hp.jpg", kind: "image", type: "carousel", sizeLabel: "2.0 MB", sizeBytes: 2097152, uploadedAt: "2026-07-30", uploadedBy: "Nadia Putri", tone: "from-lime-100 to-emerald-50 dark:from-lime-950 dark:to-zinc-900", usedBy: ["c10"], driveFileId: "drive_mock_m12" },
];
