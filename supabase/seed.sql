...
('c2', 'UMKM Kopi Luwak Mahakam', 'feed', 'idea', '2026-09-15', '13:00', 'Bima Pratama', 'BP', 'Dari biji ke cangkir: perjalanan kopi luwak Mahakam yang mendunia.', '#kawaku #umkm #kopikaltim', 'UMKM', 'Siap dijadwalkan.', null),
...
('c4', 'Ekowisata Mangrove Balikpapan', 'reels', 'idea', '2026-09-17', '15:00', 'Nadia Putri', 'NP', 'Susur hutan mangrove Balikpapan, paru-paru kota yang wajib dijaga.', '#kawaku #ekowisata #balikpapan', 'Pariwisata', 'Butuh VO dan color grading.', null),
...
('c7', 'Profil Pengrajin Ulap Doyo', 'carousel', 'idea', '2026-09-18', '11:00', 'Nadia Putri', 'NP', 'Kain Ulap Doyo, warisan Benuaq yang ditenun dengan kesabaran.', '#kawaku #ulapdoyo #wastra', 'Budaya', 'Ganti foto slide 2 yang blur, perbaiki typo slide 4.', 4),
...
('c10', 'Tips Foto Produk UMKM', 'carousel', 'idea', '2026-09-19', '14:00', 'Nadia Putri', 'NP', 'Cukup dengan HP, foto produk UMKM bisa terlihat profesional.', '#kawaku #tipsumkm', 'UMKM', '3 slide, tambah contoh before-after.', 3),
