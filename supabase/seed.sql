...
('c2', 'UMKM Kopi Luwak Mahakam', 'feed', 'review', '2026-09-15', '13:00', 'Bima Pratama', 'BP', 'Dari biji ke cangkir: perjalanan kopi luwak Mahakam yang mendunia.', '#kawaku #umkm #kopikaltim', 'UMKM', 'Menunggu approval foto hero dari tim lapangan.', null),
...
('c7', 'Profil Pengrajin Ulap Doyo', 'carousel', 'revision', '2026-09-18', '11:00', 'Nadia Putri', 'NP', 'Kain Ulap Doyo, warisan Benuaq yang ditenun dengan kesabaran.', '#kawaku #ulapdoyo #wastra', 'Budaya', 'Revisi: ganti foto slide 2 yang blur, perbaiki typo slide 4.', 4),
...
('c9', 'Behind the Scene Liputan Erau', 'story', 'approved', '2026-09-16', '18:00', 'Rizky Ramadhan', 'RR', 'Keseruan tim di lapangan selama liputan Erau!', '#kawaku #bts #erau2026', 'Budaya', 'Approved, tinggal dijadwalkan.', null),
